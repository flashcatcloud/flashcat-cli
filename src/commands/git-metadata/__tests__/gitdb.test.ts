...
describe('gitdb', () => {
  ...
  test('should unshallow repository if git version is recent and backend does not have all commits already', async () => {
    const mocks = new MockAll({
      ...
      getRemotes: [
        {
          input: undefined,
          output: [{name: 'origin', refs: {push: 'https://github.com/FLASHCAT/FLASHCAT-ci'}}],
        },
      ],
      log: [
        {
      ...
      axios: [
        {
          input: {
            ...
            data: {
              meta: {
                repository_url: 'https://github.com/FLASHCAT/FLASHCAT-ci',
              },
              data: [
                {
  ...
  test('should override repository URL when specified', async () => {
      ...
      axios: [
        {
          input: {
            ...
            data: {
              meta: {
                repository_url: 'https://github.com/FLASHCAT/mycustomrepo',
              },
              data: [
                {
                  id: '87ce64f636853fbebc05edfcefe9cccc28a7968b',
    ...
    const upload = uploadToGitDB(
      ...
      false,
      'https://github.com/FLASHCAT/mycustomrepo'
    )
    await expect(upload).resolves.toBe(undefined)
    mocks.expectCalls()
  })
