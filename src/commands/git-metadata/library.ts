...
const syncGitDB = async (simpleGit: SimpleGit, apiKey: string, flashcatSite: string, repositoryURL: string) => {
  // no-op logger
...
const uploadToSrcmapTrack = async (apiKey: string, flashcatSite: string, payload: CommitInfo) => {
