...
export class UploadCommand extends Command {
  ...
  public static usage = Command.Usage({
    category: 'RUM',
    description: 'Upload JavaScript sourcemaps to Flashcat.',
    details: `
      This command will upload all JavaScript sourcemaps and their corresponding JavaScript file to Flashcat in order to un-minify front-end stack traces received by Flashcat.\n
