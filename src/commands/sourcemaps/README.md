...
* `--enable-git` (default: false): enables the command to invoke git in the current working directory and send repository related data to Flashcat (hash, remote URL and the paths within the repository of the sources referenced in the sourcemap).
